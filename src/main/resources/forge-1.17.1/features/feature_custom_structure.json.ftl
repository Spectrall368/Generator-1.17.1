new StructureModFeatureConfiguration(new ResourceLocation("${modid}:${field$structure}"), ${field$random_rotation?lower_case}, ${field$random_mirror?lower_case}, Set.of(${input$ignored_blocks?replace(",", ".getDefaultState(),")}.getDefaultState()), new Vec3i(
