...
${field$root_radius}, BlockTags.createOptional(new ResourceLocation("${field$root_replaceable}")), ${toStateProvidertoFeatureState(input$root_state_provider)}, ${field$root_placement_attempts},
