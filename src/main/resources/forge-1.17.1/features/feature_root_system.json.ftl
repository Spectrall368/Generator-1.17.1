...
${field$root_radius}, new ResourceLocation("${field$root_replaceable}"), ${toStateProvidertoFeatureState(input$root_state_provider)}, ${field$root_placement_attempts},
...
${field$hanging_root_placement_attempts}, ${field$allowed_vertical_water_for_tree})