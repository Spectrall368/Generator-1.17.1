...
${toStateProvidertoFeatureState(input$foliage)}, null, new SpruceFoliagePlacer(UniformInt.of(0, 2), ${input$radius}, ${input$trunk_height}), <@twoLayersFeatureSize limit=2 lower_size=0 upper_size=2/>)
