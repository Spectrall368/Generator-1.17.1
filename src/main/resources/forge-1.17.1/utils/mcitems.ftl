...
<#function mappedMCItemToIngredient mappedBlock>
    <#if mappedBlock.getUnmappedValue().startsWith("TAG:")>
        <#return "Ingredient.of(ItemTags.createOptional(new ResourceLocation(\"" + mappedBlock.getUnmappedValue().replace("TAG:", "").replace("mod:", modid + ":") + "\")))">
    <#elseif mappedBlock.getMappedValue(1).startsWith("#")>
        <#return "Ingredient.of(ItemTags.createOptional(new ResourceLocation(\"" + mappedBlock.getMappedValue(1).replace("#", "") + "\")))">
    <#else>
